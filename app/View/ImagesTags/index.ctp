<div class="imagesTags index">
	...
	<tr>
		<td><?php echo h($imagesTag['ImagesTag']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $imagesTag['ImagesTag']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $imagesTag['ImagesTag']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $imagesTag['ImagesTag']['id']), null, __('Are you sure you want to delete # %s?', $imagesTag['ImagesTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
